...
$base_name = plugin_basename('wp-pagescroll/pagenavi-options.php');
...
switch($mode) {
		...
		case 'end-UNINSTALL':
			$deactivate_url = 'plugins.php?action=deactivate&amp;plugin=plugin=wp-pagescroll/wp-pagescroll.php';
			if(function_exists('wp_nonce_url')) { 
				$deactivate_url = wp_nonce_url($deactivate_url, 'deactivate-plugin_wp-pagescroll/wp-pagescroll.php');
			}
			echo '<div class="wrap">';
